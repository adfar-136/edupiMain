const curriculum = {
  html: `
    ...
    <p>Master the essentials of HTML:</p>
    <ul>
      <li>Basic HTML Understanding</li>
  ...
  css: `
    ...
    <p>Explore CSS fundamentals:</p>
    <ul>
      <li>CSS Basics Understanding</li>
      <li>Selectors and Styling Elements</li>
      <li>Box Model and Layout</li>
      <li>CSS Flexbox and Grid</li>
      <li>Responsive Design with Media Queries</li>
      <li>Transitions and Animations</li>
      <li>Fonts and Colors Styling</li>
      <li>CSS Variables and Custom Properties</li>
      <li>Maintainable Stylesheets Best Practices</li>
    </ul>
  `,
  js: `
    <h2>JavaScript Curriculum Content</h2>
    <p>Dive into JavaScript essentials:</p>
    <ul>
  ...
  react: `
    ...
    <p>Build powerful web experiences with React:</p>
    <ul>
      ...
      <li>List and Keys Usage</li>
      <li>React Hooks Exploration</li>
  ...
  node: `
    ...
    <p>Explore the backend with Node.js:</p>
    <ul>
  ...
  dsa: `
    ...
    <p>Enhance coding prowess with Data Structures and Algorithms:</p>
    <ul>
      <li>Introduction to Data Structures</li>
      <li>Arrays and Lists Exploration</li>
  ...
  interview: `
    ...
    <p>Master technical and behavioral interviews:</p>
    <ul>
